...
export const register =async (req:Request, res:Response):Promise<void> => {
    ...
    console.log("hola")
    const {nombre,surname,age, email, password,cellphone,location,address}: IUser = req.body //desestructuramos la respuesta que viene en el body de la Request
    
    const usuario = new Usuario({nombre,surname,age, email, password,cellphone,location,address}) //creamos el nuevo usuario utilizando el esquema de usuario
